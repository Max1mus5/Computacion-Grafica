"""
Django settings for proyecto_visor_imagen project.
...
WSGI_APPLICATION = 'proyecto_visor_imagen.wsgi.application'
...
# Verificamos si el directorio existe antes de incluirlo
import os
